...
class Demo extends React.PureComponent {
  ...
  handleSubmit = (event) => {
    ...
    var songData = {
      ...
      singer: event.target.songArtist.value,
      cover: '',
      musicSrc: event.target.songLink.value,
    }

    this.onAddAudio(songData);
  }
      ...
      <>
        ...
        <section className="settings">
          <form onSubmit={this.handleSubmit}>
            ...
            <br />
            <label for="name">song artist:</label>
            <input type="text" name="songArtist" />
            <br />
            <label for="name">song link:</label>
            <input type="text" name="songLink" />
            <br />
            <label for="name">song file:</label>
            <input id="fileupload" type="file" name="fileupload" accept=".mp3" />
            <br />
          ...
          {
            this.state.params.audioLists.map((data, key) =>
